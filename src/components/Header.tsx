    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-5">
        <div className="flex justify-between items-center">
          ...
          >
            <Button 
              className="bg-white/5 backdrop-blur-sm border border-white/20 text-white hover:bg-white/10 hover:border-white/30 transition-all duration-300 px-6 py-2.5 font-semibold tracking-wide rounded-lg hover:scale-105 shadow-lg hover:shadow-xl"
